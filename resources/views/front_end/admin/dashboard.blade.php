                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a href="{{URL::to('/manage_category')}}"><i class="icon-envelope"></i><span class="hidden-tablet">Manage Category</span></a></li>
                            ...
                            <li><a href="{{URL::to('/manage-product')}}"><i class="icon-envelope"></i><span class="hidden-tablet">Manage Product</span></a></li>
                            <li><a href="{{URL::to('/manage-order')}}"><i class="icon-envelope"></i><span class="hidden-tablet">Manage Order</span></a></li>
