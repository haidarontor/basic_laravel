                            ...
                            <div id="products_example">
                                <div id="products">
                                    <div class="slides_container">
                                        <a href="#" target="_blank"><img src="{{asset('public/front_end/')}}/images/productslide-1.jpg" alt=" " /></a>
                                        <a href="#" target="_blank"><img src="{{asset('public/front_end/')}}/images/productslide-2.jpg" alt=" " /></a>
                                        <a href="#" target="_blank"><img src="{{asset('public/front_end/')}}/images/productslide-3.jpg" alt=" " /></a>					
                                        <a href="#" target="_blank"><img src="{{asset('public/front_end/')}}/images/productslide-4.jpg" alt=" " /></a>
                                        <a href="#" target="_blank"><img src="{{asset('public/front_end/')}}/images/productslide-5.jpg" alt=" " /></a>
                                        <a href="#" target="_blank"><img src="{{asset('public/front_end/')}}/images/productslide-6.jpg" alt=" " /></a>
                                    </div>
                                    <ul class="pagination">
